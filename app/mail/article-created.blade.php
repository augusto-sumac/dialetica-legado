...
<head>
    ...
    <title>Olá {{ $name }}, o seu artigo foi submetido com sucesso</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:georgia, times, \'times new roman\', serif;line-height:17px;color:#333333;font-size:14px">
                                                                        Confirmo o recebimento do seu artigo intitulado
                                                                        <b>{{ $title }}</b> foi submetido com
                                                                        sucesso na
                                                                        plataforma de submissão da Editora
                                                                        Dialética.&nbsp;<br>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:georgia, times, \'times new roman\', serif;line-height:17px;color:#333333;font-size:14px">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:georgia, times, \'times new roman\', serif;line-height:17px;color:#333333;font-size:14px">
                                                                        Seu artigo segue agora para análise do nosso
                                                                        Conselho Editorial, que conta com um corpo de
                                                                        profissionais dedicados à avaliação dos
                                                                        trabalhos e em cerca de <b>uma semana
                                                                        </b>enviarei a você o resultado.</p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:georgia, times, \'times new roman\', serif;line-height:17px;color:#333333;font-size:14px">
                                                                        <br>
                                                                    </p>
