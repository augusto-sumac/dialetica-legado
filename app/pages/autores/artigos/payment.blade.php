        ...
        <div class="card-body pt-0">
            ...
            <div class="form-group mt-0 mb-0">
                <div class="col-sm-6 offset-sm-3">
                    ...
                    <a class="btn btn-default ml-4 form-cancel" href="{{ url(AUTHOR_ARTICLES_BASE_URL . '/' . $id) }}">
                        Cancelar e retornar
                    </a>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(document)
                ...
                .on('change', '[name="discount_coupon"]', function() {
                    ...
                    $.get(baseUrl + '/artigos/{{ $id }}/cupom/' + token)
                        .done(function(data) {
                            console.log(data);
