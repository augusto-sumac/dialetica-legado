...
<div class="form-group row align-items-end filter-group" style="display: none;">
    <div class="col-xs-12 col-md-3 mb-3 mb-md-0">
        ...
        <div class="col-12">
            <select class="form-control-sm form-select-sm" name="filters[discount_rule][]" placeholder="Tipo Desconto"
                data-multiple="true" data-size="sm">
                {{ select_options_affiliates_value_rule(null) }}
            </select>
        </div>
    </div>
    <div class="col-xs-12 col-md-3 mb-3 mb-md-0">
        ...
        <div class="col-12">
            <select class="form-control-sm form-select-sm" name="filters[affiliate_rule][]" placeholder="Tipo Comissão"
                data-multiple="true" data-size="sm">
                {{ select_options_affiliates_value_rule(null) }}
            </select>
        </div>
    ...
    <div class="col-xs-12 col-md-3 mb-3 mb-md-0">
        ...
        <div class="col-12">
            <select class="form-control-sm form-select-sm" name="filters[type][]" placeholder="Aplicação"
                data-multiple="true" data-size="sm">
                <option>Selecione...</option>
                <option value="ARTICLES">Artigos</option>
                <option value="REVIEWS">Revisões</option>
...
<div class="form-group row align-items-end filter-group" style="display: none;">
    ...
    <div class="col">
        <label class="col-form-label col-form-label-sm mt-0">
            Data Validate Inicial
            <a href="javascript:void(0)" class="clear-input-filter">[ limpar ]</a>
        </label>
        <div class="col-12">
            <div class="input-group input-group-sm">
                <input type="text" class="form-control campo-data" name="filters[start_at][start]" />
                <span class="input-group-text bg-light">até</span>
                <input type="text" class="form-control campo-data" name="filters[start_at][end]" />
            </div>
        </div>
    </div>
    <div class="col">
