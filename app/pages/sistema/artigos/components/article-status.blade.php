<script id="article-status" type="text/x-handlebars-template">
    <div class="form-group">
        ...
        ${#if is_cancellable }}
        <div class="mt-5">
            <button class="btn btn-sm btn-danger btn-cancelar-artigo" title="Cancelar Artigo">
                <span class="fas fa-trash me-1"></span> Cancelar Artigo
            </button>
        </div>
        ${/if}}
    </div>
                ...
                ${else}}
                    <div class="row mt-3 nf-status">
                        <div class="col">
                            ...
                            ${#if download }}
                                <div class="mt-3">
                                    <a href="${baseUrl}}/artigos/${id}}/invoice/pdf" class="btn btn-light btn-sm" target="invoice-pdf">
