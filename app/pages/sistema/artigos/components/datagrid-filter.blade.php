...
<div class="form-group row align-items-end filter-group" style="display: none;">
    <div class="col-xs-12 col-md-4 mb-3 mb-md-0">
        ...
        <div class="col-12">
            <select class="form-select form-control-sm form-select-sm" name="filters[area]" placeholder="Área">
    ...
    <div class="col-xs-12 col-md-4 mb-3 mb-md-0">
        ...
        <div class="col-12">
            <select class="form-control-sm form-select-sm" name="filters[sub_area]" placeholder="Sub-Área">
            </select>
        </div>
    </div>
    <div class="col-xs-12 col-md-4 ">
        ...
        <div class="col-12">
            <select class="form-control-sm form-select-sm" name="filters[especialidade]" placeholder="Especialidade">
            </select>
        </div>
    </div>
</div>
    ...
    <div class="col-xs-12 col-md-3 mb-3 mb-md-0">
        ...
        <div class="col-12">
            <select class="form-control-sm form-select-sm" name="filters[status][]" placeholder="Status"
                ...
                {{ select_options_article_status(null) }}
            </select>
        </div>
    </div>
    <div class="col-xs-12 col-md-3 mb-3 mb-md-0">
