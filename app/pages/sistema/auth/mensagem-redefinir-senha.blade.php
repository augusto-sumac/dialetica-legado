    ...
    <center>
        <div style="max-width: 800px; width:100%; background-color: #fff; color: #333;">
            <div style="background-color:#086c7e;" align="center">
                <img src="{{ url('public/img/logo.png') }}" style="padding:20px; width: 100px; border-radius: 5px;" />
            ...
            <div class="arial" id="form" style="padding:40px; border: 1px solid #CCC;" align="justify">
                ...
                <p>
                    ...
                    <a href="{{ url('/sistema/auth/login') }}"
                        style="font-weight: bold; text-decoration: none; color: #086c7e;">Login - Editora Dialética</a>
                ...
                <p>
                    ...
                    <a href="{{ url('/sistema/auth/redefinir-senha?token=' . $token) }}"
                        style="font-weight: bold; text-decoration: none; color: #086c7e;">
                        clique aqui
                    </a>
            ...
            <div style="background-color: #086c7e; height: 40px; padding-top: 20px; color: #fff; font-size: 14px;"
                align="center">
                {{ config('app_name', 'Editora Dialética') }} &copy; {{ date('Y') }} - Todos os Direitos
                Reservados
            </div>
        </div>
    </center>
