...
(function (factory) {
    ...
    $.serializeObject = {
        defaultOptions: {}, // reassign to override option defaults for all serializeObject calls
        ...
        setupOpts: function (options) {
            ...
            for (var opt in options) {
                if (validOpts.indexOf(opt) === -1) {
                    throw new Error(
                        "serializeObject ERROR: invalid option '" +
                            opt +
                            "'. Please use one of " +
                            validOpts.join(", ")
                    );
        ...
        applyTypeFunc: function (name, strVal, type, el, typeFunctions) {
            ...
            if (!typeFunc) {
                ...
                throw new Error(
                    "serializeObject ERROR: Invalid type " +
                        type +
                        " found in input name '" +
                        name +
                        "', please use one of " +
        ...
        // This is the main function of the script, that allows serializeObject to use nested keys.
        // Examples:
        //
