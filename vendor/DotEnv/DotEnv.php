...
require_once(__DIR__ . '/Processor/AbstractProcessor.php');
require_once(__DIR__ . '/Processor/BooleanProcessor.php');
require_once(__DIR__ . '/Processor/QuotedProcessor.php');
