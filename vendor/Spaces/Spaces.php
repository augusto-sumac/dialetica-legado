...
class SpacesConnect
{
  ...
  */
  ...
  public function __construct($access_key, $secret_key, $spaceName = "", $region = "nyc3", $host = "digitaloceanspaces.com")
  {
  ...
  /*
      Creates a Space.
    */
  public function CreateSpace($spaceName, $region = "")
  {
    if (empty($region)) {
      $region = $this->region;
    }
  ...
  /*
      Lists all objects.
    */
  public function ListObjects($of_directory = "")
  {
    try {
  ...
  /*
    ...
    */
  public function GetObject($file_name = "")
  {
    try {
  ...
  /*
    ...
    */
  public function MakePrivate($file_path = "")
  {
    try {
  ...
  /*
    ...
    */
  public function MakePublic($file_path = "")
  {
    try {
  ...
  /*
      Deletes an object.
    */
  public function DeleteObject($file_path = "", $recursive = false)
  {
    try {
  ...
  /*
    ...
    */
  public function PutCORS($cors_rules = "")
  {
    if (empty($cors_rules)) {
      $cors_rules = [
        'AllowedMethods' => ['GET'],
  ...
  /*
    ...
    */
  public function CreateTemporaryURL($file_name = "", $valid_for = "1 hour")
  {
  ...
  /*
    ...
    */
  public function ObjReturn($return)
  {
  ...
  /*
    ...
    */
  public function HandleAWSException($e)
  {
